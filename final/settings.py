...
ALLOWED_HOSTS = _split_csv(os.getenv("DJANGO_ALLOWED_HOSTS", "localhost,127.0.0.1,202.28.49.122"))

# CSRF ให้ไว้ทั้ง http/https
...
if not DEBUG:
    ...
    CSRF_COOKIE_SECURE = os.getenv("DJANGO_SECURE_COOKIES","true").lower()=="true"
